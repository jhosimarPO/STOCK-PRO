...
export function TablaProductos({
  ...
  function editar(data) {
    ...
    setdataSelect(data);
    setAccion("Editar");
    selectMarca({id:data.idmarca,descripcion:data.marca})
    selectCategoria({id:data.id_categoria,descripcion:data.categoria})
  }
  const columns = [
    {
      accessorKey: "image",
      header: "Foto",
      cell: (info) => <img style={{ height : '60px' , objectFit : 'contain' , borderRadius : '8px' }} src={info.getValue()} alt="imagen" />,
